...
contract ModularCompliance is IModularCompliance, OwnableUpgradeable, MCStorage {
    ...
    function bindToken(address _token) external override {
        require(owner() == msg.sender || (_tokenBound == address(0) && msg.sender == _token) || msg.sender == council,
    ...
    */
    ...
    function addModule(address _module) external override  {
        require(msg.sender == owner() || msg.sender == council ,"only owner or council can call");
